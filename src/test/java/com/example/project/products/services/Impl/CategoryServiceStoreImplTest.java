...
@Transactional
public class CategoryServiceStoreImplTest {
    @Autowired
    CategoryServiceStoreImpl service;
    @Autowired
    ...
    void testfindCategoryById_whenGivenCorrectId_shouldFindTheCategoryAndTurnToDto() {
        ...
        // run
        var res = service.findCategoryById(expected.getId());
        // assert
        assertThat(res).isEqualTo(mapper.toDto(expected));
    }
